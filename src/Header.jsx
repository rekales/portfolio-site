      ...
      <div className="header-links">
        <div className="header-link-container">
          <svg width="48" height="48" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
            <path stroke="#ffffffcc" stroke-linecap="round" stroke-linejoin="round" stroke-width="12" 
        ...
        <div className="header-link-container">
          <svg width="48" height="48" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg" fill="none">
            ...
            <ellipse cx="71" cy="101" fill="#ffffffcc" rx="13" ry="15"/>
            <ellipse cx="121" cy="101" fill="#ffffffcc" rx="13" ry="15"/>
          </svg>
        ...
        <div className="header-link-container">
          <svg width="48" height="48" viewBox="0 0 50.8 50.8" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" stroke="#ffffffcc">
